...
public class Barbermen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Glide.with(this).load(R.drawable.aa).into((ImageView) findViewById(R.id.backdrop));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void getResponall(){
        ...
        call.enqueue(new Callback<AlluserRespons>() {
            ...
            public void onFailure(Call<AlluserRespons> call, Throwable t) {
                Toast.makeText(Barbermen.this, "Gagal Mengambil Data Dari Server Pastikan Anda Terhubung Dengan Internet " , Toast.LENGTH_SHORT).show();
            }
        });
    }
