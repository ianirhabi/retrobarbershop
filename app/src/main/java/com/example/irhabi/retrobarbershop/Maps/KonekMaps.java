...
public class KonekMaps extends AppCompatActivity {

    private static final String TAG = KonekMaps.class.getSimpleName();
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(KonekMaps.this, REQUEST_CHECK_SETTINGS);
